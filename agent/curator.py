...
CURATOR_REVIEW_PROMPT = (
    ...
    "CRITICAL: Before calling skill_manage with action=patch, create, "
    "write_file, or delete on any skill, you MUST first call skill_view(name) "
    "to load its content. The system enforces a read-before-write guard — "
    "skill_manage will refuse mutations on files you haven't viewed in the "
    "current turn.\n\n"
